...
const LoadingScreen = (): JSX.Element => {
    ...
    const [ currentStatus, setCurrentStatus ] = useState("Getting things started...");
    ...
    useEffect(() => {
        ...
        setCurrentStatus("Getting things started...");
        increaseProgress();
    }, []);

    const fetchProgress = async () => {
        // const url: string = resourceEndpoint.applications + "/" + "ai/loginflow/status";
        const url: string = "http://localhost:3000/loginflow/status";
    ...
    const updateProgress = (fetchedStatus: Record<string, any>) => {
        ...
        if (fetchedStatus.login_flow_generation_complete) {
            ...
            // Response is generated and the loading screen is left before completing.
        }
    };
